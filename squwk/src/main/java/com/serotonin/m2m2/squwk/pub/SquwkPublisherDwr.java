...
public class SquwkPublisherDwr extends PublisherEditDwr
{
  ...
  public ProcessResult saveSquwkSender(String name, String xid, boolean enabled, List<SquwkPointVO> points, String accessKey, String secretKey, int cacheWarningSize, int cacheDiscardSize, boolean changesOnly, boolean sendSnapshot, int snapshotSendPeriods, int snapshotSendPeriodType)
  {
