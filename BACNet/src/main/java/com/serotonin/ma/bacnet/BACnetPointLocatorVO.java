...
public abstract class BACnetPointLocatorVO extends AbstractPointLocatorVO
  implements JsonSerializable
{
  ...
  public TranslatableMessage getConfigurationDescription()
  {
    if (this.networkNumber != 0) {
      return new TranslatableMessage("common.default", new Object[] { this.remoteDeviceInstanceNumber + "@" + this.networkNumber + "/" + this.mac });
    }
    return new TranslatableMessage("common.default", new Object[] { this.mac });
  }
  ...
  {
    return ObjectProperties.isCommandable(new ObjectType(this.objectTypeId), new PropertyIdentifier(this.propertyIdentifierId));
  }

  public void validate(ProcessResult response)
  {
    if ((this.networkNumber < 0) || (this.networkNumber > 65534))
      response.addContextualMessage("networkNumber", "validate.illegalValue", new Object[0]);
    try
    {
      new OctetString(this.mac);
    }
    catch (RuntimeException e) {
      response.addContextualMessage("mac", "common.default", new Object[] { e.getMessage() });
    }

    if (StringUtils.isBlank(this.link)) {
      if (this.networkNumber != 0)
        response.addContextualMessage("link", "mod.bacnet.link.required", new Object[0]);
    }
    else {
      try {
        new OctetString(this.link);
      }
      catch (IllegalArgumentException e) {
        response.addContextualMessage("link", "common.default", new Object[] { e.getMessage() });
      }
    }
    try
    {
      new ObjectIdentifier(null, this.remoteDeviceInstanceNumber);
    }
    catch (IllegalArgumentException e) {
      response.addContextualMessage("remoteDeviceInstanceNumber", "validate.illegalValue", new Object[0]);
    }

    if (!OBJECT_TYPE_CODES.isValidId(this.objectTypeId, new int[0])) {
      response.addContextualMessage("objectTypeId", "validate.invalidValue", new Object[0]);
    }
    if (!PROPERTY_TYPE_CODES.isValidId(this.propertyIdentifierId, new int[0]))
      response.addContextualMessage("propertyIdentifierId", "validate.invalidValue", new Object[0]);
    try
    {
      new ObjectIdentifier(null, this.objectInstanceNumber);
    }
    catch (IllegalArgumentException e) {
      response.addContextualMessage("objectInstanceNumber", "validate.illegalValue", new Object[0]);
    }
    ...
    if ((this.writePriority < 1) || (this.writePriority > 16))
      response.addContextualMessage("writePriority", "validate.illegalValue", new Object[0]);
  }

  public void addProperties(List<TranslatableMessage> list)
  {
    AuditEventType.addPropertyMessage(list, "mod.bacnet.remoteDeviceNetworkNumber", Integer.valueOf(this.networkNumber));
    AuditEventType.addPropertyMessage(list, "mod.bacnet.remoteDeviceMac", this.mac);
    AuditEventType.addPropertyMessage(list, "mod.bacnet.remoteDeviceInstanceNumber", Integer.valueOf(this.remoteDeviceInstanceNumber));
    AuditEventType.addExportCodeMessage(list, "mod.bacnet.objectType", OBJECT_TYPE_CODES, this.objectTypeId);
    AuditEventType.addPropertyMessage(list, "mod.bacnet.objectInstanceNumber", Integer.valueOf(this.objectInstanceNumber));
    AuditEventType.addPropertyMessage(list, "mod.bacnet.useCov", this.useCovSubscription);
    ...
    AuditEventType.addPropertyMessage(list, "mod.bacnet.writePriority", Integer.valueOf(this.writePriority));
  }

  public void addPropertyChanges(List<TranslatableMessage> list, Object o)
  {
    BACnetPointLocatorVO from = (BACnetPointLocatorVO)o;
    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.remoteDeviceNetworkNumber", from.networkNumber, this.networkNumber);

    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.remoteDeviceMac", from.mac, this.mac);
    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.remoteDeviceInstanceNumber", from.remoteDeviceInstanceNumber, this.remoteDeviceInstanceNumber);

    AuditEventType.maybeAddExportCodeChangeMessage(list, "mod.bacnet.objectType", OBJECT_TYPE_CODES, from.objectTypeId, this.objectTypeId);

    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.objectInstanceNumber", from.objectInstanceNumber, this.objectInstanceNumber);

    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.useCov", from.useCovSubscription, this.useCovSubscription);
    ...
    AuditEventType.maybeAddPropertyChangeMessage(list, "mod.bacnet.writePriority", from.writePriority, this.writePriority);
  }
    ...
    throws IOException
  {
    ...
    SerializationHelper.writeSafeUTF(out, this.mac);
    SerializationHelper.writeSafeUTF(out, this.link);
  ...
  private void readObject(ObjectInputStream in) throws IOException {
    ...
    if (ver == 1) {
      ...
      this.mac = SerializationHelper.readSafeUTF(in);
      this.link = SerializationHelper.readSafeUTF(in);
  ...
  public void jsonWrite(ObjectWriter writer) throws IOException, JsonException
  {
    ...
    writer.writeEntry("objectType", OBJECT_TYPE_CODES.getCode(this.objectTypeId));
    writer.writeEntry("propertyIdentifier", PROPERTY_TYPE_CODES.getCode(this.propertyIdentifierId));
  }
  ...
  public void jsonRead(JsonReader reader, JsonObject jsonObject) throws JsonException
  {
    ...
    String text = jsonObject.getString("objectType");
    if (text != null) {
      this.objectTypeId = OBJECT_TYPE_CODES.getId(text, new int[0]);
      if (this.objectTypeId == -1) {
        throw new TranslatableJsonException("emport.error.invalid", new Object[] { "objectType", text, OBJECT_TYPE_CODES.getCodeList(new int[0]) });
      }
    }

    text = jsonObject.getString("propertyIdentifier");
    if (text != null) {
      this.propertyIdentifierId = PROPERTY_TYPE_CODES.getId(text, new int[0]);
      if (this.propertyIdentifierId == -1)
        throw new TranslatableJsonException("emport.error.invalid", new Object[] { "propertyIdentifier", text, PROPERTY_TYPE_CODES.getCodeList(new int[0]) });
    }
  }

  static
  {
    OBJECT_TYPE_CODES.addElement(ObjectType.analogInput.intValue(), "ANALOG_INPUT", "mod.bacnet.objectType.analogInput");

    OBJECT_TYPE_CODES.addElement(ObjectType.analogOutput.intValue(), "ANALOG_OUTPUT", "mod.bacnet.objectType.analogOutput");

    OBJECT_TYPE_CODES.addElement(ObjectType.analogValue.intValue(), "ANALOG_VALUE", "mod.bacnet.objectType.analogValue");

    OBJECT_TYPE_CODES.addElement(ObjectType.binaryInput.intValue(), "BINARY_INPUT", "mod.bacnet.objectType.binaryInput");

    OBJECT_TYPE_CODES.addElement(ObjectType.binaryOutput.intValue(), "BINARY_OUTPUT", "mod.bacnet.objectType.binaryOutput");

    OBJECT_TYPE_CODES.addElement(ObjectType.binaryValue.intValue(), "BINARY_VALUE", "mod.bacnet.objectType.binaryValue");

    OBJECT_TYPE_CODES.addElement(ObjectType.calendar.intValue(), "CALENDAR", "mod.bacnet.objectType.calendar");
    OBJECT_TYPE_CODES.addElement(ObjectType.command.intValue(), "COMMAND", "mod.bacnet.objectType.command");
    OBJECT_TYPE_CODES.addElement(ObjectType.device.intValue(), "DEVICE", "mod.bacnet.objectType.device");
    OBJECT_TYPE_CODES.addElement(ObjectType.eventEnrollment.intValue(), "EVENT_ENROLLMENT", "mod.bacnet.objectType.eventEnrollment");

    OBJECT_TYPE_CODES.addElement(ObjectType.file.intValue(), "FILE", "mod.bacnet.objectType.file");
    OBJECT_TYPE_CODES.addElement(ObjectType.group.intValue(), "GROUP", "mod.bacnet.objectType.group");
    OBJECT_TYPE_CODES.addElement(ObjectType.loop.intValue(), "LOOP", "mod.bacnet.objectType.loop");
    OBJECT_TYPE_CODES.addElement(ObjectType.multiStateInput.intValue(), "MULTISTATE_INPUT", "mod.bacnet.objectType.multiStateInput");

    OBJECT_TYPE_CODES.addElement(ObjectType.multiStateOutput.intValue(), "MULTISTATE_OUTPUT", "mod.bacnet.objectType.multiStateOutput");

    OBJECT_TYPE_CODES.addElement(ObjectType.notificationClass.intValue(), "NOTIFICATION_CLASS", "mod.bacnet.objectType.notificationClass");

    OBJECT_TYPE_CODES.addElement(ObjectType.program.intValue(), "PROGRAM", "mod.bacnet.objectType.program");
    OBJECT_TYPE_CODES.addElement(ObjectType.schedule.intValue(), "SCHEDULE", "mod.bacnet.objectType.schedule");
    OBJECT_TYPE_CODES.addElement(ObjectType.averaging.intValue(), "AVERAGING", "mod.bacnet.objectType.averaging");
    OBJECT_TYPE_CODES.addElement(ObjectType.multiStateValue.intValue(), "MULTISTATE_VALUE", "mod.bacnet.objectType.multiStateValue");

    OBJECT_TYPE_CODES.addElement(ObjectType.trendLog.intValue(), "TREND_LOG", "mod.bacnet.objectType.trendLog");
    OBJECT_TYPE_CODES.addElement(ObjectType.lifeSafetyPoint.intValue(), "LIFE_SAFETY_POINT", "mod.bacnet.objectType.lifeSafetyPoint");

    OBJECT_TYPE_CODES.addElement(ObjectType.lifeSafetyZone.intValue(), "LIFE_SAFETY_ZONE", "mod.bacnet.objectType.lifeSafetyZone");

    OBJECT_TYPE_CODES.addElement(ObjectType.accumulator.intValue(), "ACCUMULATOR", "mod.bacnet.objectType.accumulator");

    OBJECT_TYPE_CODES.addElement(ObjectType.pulseConverter.intValue(), "PULSE_CONVERTER", "mod.bacnet.objectType.pulseConverter");

    OBJECT_TYPE_CODES.addElement(ObjectType.eventLog.intValue(), "EVENT_LOG", "mod.bacnet.objectType.eventLog");
    OBJECT_TYPE_CODES.addElement(ObjectType.trendLogMultiple.intValue(), "TREND_LOG_MULTIPLE", "mod.bacnet.objectType.trendLogMultiple");

    OBJECT_TYPE_CODES.addElement(ObjectType.loadControl.intValue(), "LOAD_CONTROL", "mod.bacnet.objectType.loadControl");

    OBJECT_TYPE_CODES.addElement(ObjectType.structuredView.intValue(), "STRUCTURE_VIEW", "mod.bacnet.objectType.structuredView");

    OBJECT_TYPE_CODES.addElement(ObjectType.accessDoor.intValue(), "ACCESS_DOOR", "mod.bacnet.objectType.accessDoor");

    PROPERTY_TYPE_CODES = new ExportCodes();
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.applicationSoftwareVersion.intValue(), "APPLICATION_SOFTWARE_VERSION");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.controlledVariableReference.intValue(), "CONTROLLED_VARIABLE_REFERENCE");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.controlledVariableUnits.intValue(), "CONTROLLED_VARIABLE_UNITS");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.controlledVariableValue.intValue(), "CONTROLLED_VARIABLE_VALUE");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.derivativeConstantUnits.intValue(), "DERIVATIVE_CONSTANT_UNITS");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.listOfObjectPropertyReferences.intValue(), "LIST_OF_OBJECT_PROPERTY_REFERENCES");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.manipulatedVariableReference.intValue(), "MANIPULATED_VARIABLE_REFERENCE");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.objectPropertyReference.intValue(), "OBJECT_PROPERTY_REFERENCE");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.proportionalConstantUnits.intValue(), "PROPORTIONAL_CONSTANT_UNITS");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.protocolObjectTypesSupported.intValue(), "PROTOCOL_OBJECT_TYPES_SUPPORTED");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.protocolServicesSupported.intValue(), "PROTOCOL_SERVICES_SUPPORTED");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.reasonForHalt.intValue(), "REASON_FOR_HALT");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.timeOfActiveTimeReset.intValue(), "TIME_OF_ACTIVE_TIME_RESET");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.timeOfStateCountReset.intValue(), "TIME_OF_STATE_COUNT_RESET");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.timeSynchronizationRecipients.intValue(), "TIME_SYNCHRONIZATION_RECIPIENTS");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.covResubscriptionInterval.intValue(), "COV_RESUBSCRIPTION_INTERVAL");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.logDeviceObjectProperty.intValue(), "LOG_DEVICE_OBJECT_PROPERTY");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.recordsSinceNotification.intValue(), "RECORDS_SINCE_NOTIFICATION");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.activeCovSubscriptions.intValue(), "ACTIVE_COV_SUBSCRIPTIONS");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.manualSlaveAddressBinding.intValue(), "MANUAL_SLAVE_ADDRESS_BINDING");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.limitMonitoringInterval.intValue(), "LIMIT_MONITORING_INTERVAL");
    ...
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.restartNotificationRecipients.intValue(), "RESTART_NOTIFICATION_RECIPIENTS");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.timeOfDeviceRestart.intValue(), "TIME_OF_DEVICE_RESTART");
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.timeSynchronizationInterval.intValue(), "TIME_SYNCHRONIZATION_INTERVAL");

    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.trigger.intValue(), "TRIGGER");
    PROPERTY_TYPE_CODES.addElement(PropertyIdentifier.utcTimeSynchronizationRecipients.intValue(), "UTC_TIME_SYNCHRONIZATION_RECIPIENTS");
