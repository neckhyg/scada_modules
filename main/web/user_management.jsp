...
<main:eazyPage dwr="UsersDwr" onload="init">
...
//                 document.getElementById('allowed').innerHTML = ss;
    ...
    function showUserCB(user) {
        ...
        $set("sewageCompany", user.sewageCompany);
        $set("sewageRecord", user.sewageRecord);
    ...
    function saveUser() {
        ...
        if (adminUser) {
            ...
            UsersDwr.saveUserAdmin(editingUserId, $get("username"), $get("password"), $get("email"), $get("phone"), 
                    ...
                    $get("timezone"),$get("sewageCompany"),$get("sewageRecord"), dsPermis, dpPermis, saveUserCB);
        }
        else
            ...
            <td valign="top" style="display:none;" id="userDetails">
              <div class="borderDiv">
                ...
                <table>
                  ...
                  <tr>
                    <td class="formLabelRequired"><fmt:message key="users.sewageCompanyMgm"/></td>
                    <td class="formField"><input id="sewageCompany" type="checkbox" onclick="updateUserImg();"/></td>
                  </tr>
                  <tr>
                    <td class="formLabelRequired"><fmt:message key="users.sewageRecordMgm"/></td>
                    <td class="formField"><input id="sewageRecord" type="checkbox" onclick="updateUserImg();"/></td>
                  </tr>
