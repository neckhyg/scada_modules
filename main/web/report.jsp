...
<main:eazyPage dwr="ReportsDwr" js="/resources/emailRecipients.js" onload="init">
        ...
        <div class="borderDiv marR">
          <table width="100%">
            <tr>
              ...
              <td align="right"><tag:img src="/modules/reports/web/report_add.png" title="reports.newReport"
          ...
          <table id="reportsTable">
            <tbody id="r_TEMPLATE_" onclick="loadReport(getMangoId(this), false)" class="ptr" style="display:none;"><tr>
              <td><tag:img id="r_TEMPLATE_Img" src="/modules/reports/web/report_small.png" title="reports.report"/></td>
      ...
      <td valign="top" id="reportDetails" style="display:none;">
        <div class="borderDiv">
          <table width="100%">
            <tr>
              <td>
                <span class="smallTitle"><tag:img id="reportImg" src="/modules/reports/web/report_small.png" title="reports.report"/>
                <fmt:message key="reports.criteria"/></span>
              </td>
              <td align="right">
                <tag:img id="deleteImg" png="delete" title="common.delete" onclick="deleteReport();"/>
                <tag:img id="runImg" src="/modules/reports/web/report_go.png" onclick="runReport();" title="reports.runNow"/>
                <tag:img id="saveImg" png="save" onclick="saveReport();" title="common.save"/>
                <tag:img id="copyImg" src="/modules/reports/web/report_add.png" onclick="loadReport(selectedReport.id, true);" title="common.copy"/>
              </td>
            </tr>
    ...
    <div class="borderDiv marB" style="max-height:300px;overflow:auto;">
      <table width="100%">
        <tr>
          ...
          <td align="right">
            <tag:img id="reportInstancesRefreshImg" png="control_play_blue" title="common.refresh" onclick="refreshReportInstanceList()"/>
          </td>
        </tr>
      </table>
