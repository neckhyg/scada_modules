...
<main:eazyPage dwr="EventsDwr" >
  ...
  <div id="datePickerDiv" style="position:absolute; top:0px; left:0px;display:none" onmouseover="cancelDatePickerExpiry()" onmouseout="expireDatePicker()">
