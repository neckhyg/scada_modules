        ...
        <div class="borderDiv marR">
          ...
          <table id="reportsTable">
            <tbody id="r_TEMPLATE_" onclick="loadReport(getMangoId(this), false)" class="ptr" style="display:none;"><tr>
              <td><tag:img id="r_TEMPLATE_Img" src="${modulePath}/web/report_small.png" title="reports.report"/></td>
      ...
      <td valign="top" id="reportDetails" style="display:none;">
        <div class="borderDiv">
          <table width="100%">
            <tr>
              <td>
                <span class="smallTitle"><tag:img id="reportImg" src="${modulePath}/web/report_small.png" title="reports.report"/>
